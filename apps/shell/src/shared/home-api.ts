...
export interface HomeApi {
  ...
  /** current AI provider settings (provider/apiKey/model/baseUrl); persisted in the docs settings file */
  getAiSettings(): Promise<AiSettings>
  /** persist AI provider settings (provider/apiKey/model/baseUrl) */
